...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["View Data", "Add Incident", "Update Status", "Delete", "AI Operations"])
...
with tab5:
    ...
    AIconn = get_conn()
    incidents_data = get_all_incidents(AIconn)

    if isinstance(incidents_data, pd.DataFrame):
        incidents_list = incidents_data.to_dict('records')
    else:
...
4. Risk assessment"""
                ...
                st.subheader("AI Assistant Incident Analysis")
